...
<template>
  <div class="flex items-center justify-center min-h-screen bg-[#12151C] p-6">
    ...
    <div class="w-full max-w-[380px]">
      ...
      <!-- État 1 : formulaire -->
      <template v-if="!sent">
        <h1 class="text-center text-[#E8EAF0] text-[24px] font-serif font-medium mb-1">Mot de passe oublié ?</h1>
      ...
      <!-- État 2 : lien envoyé -->
      <template v-else>
        <h1 class="text-center text-[#E8EAF0] text-[24px] font-serif font-medium mb-1">Vérifie ta boîte mail</h1>
        <p class="text-center text-[#8B93A7] text-[13.5px] mb-7">
        ...
        <div class="space-y-4">
          ...
          <div class="text-center mt-5 text-[13px] text-[#8B93A7] space-y-2">
            <p>
              ...
              <button type="button" class="text-[#FF7A33] font-semibold hover:underline transition-colors" @click="useAnotherEmail">
                change d’adresse
              </button>.
            </p>
            <p>
