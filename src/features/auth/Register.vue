...
<template>
  <div class="flex items-center justify-center min-h-screen bg-[#12151C] p-6">
    <div class="card-auth">
      ...
      <h1 class="text-center text-[#E8EAF0] text-2xl font-serif font-medium mb-1">
        Créer un compte
      </h1>
      ...
      <div class="space-y-4">
        ...
        <div class="space-y-1">
          ...
          <input v-model="fullName" type="text" class="input-field" placeholder="Prénom Nom" />
        </div>
        ...
        <div class="space-y-1">
          ...
          <div v-if="password" class="space-y-1.5">
            ...
            <p v-if="!passwordStrength.isValid" class="text-red-400 text-[11px]">
              Le mot de passe doit contenir : 12+ caractères, 1 majuscule, 1 minuscule, 1 chiffre, 1
              caractère spécial
            </p>
          </div>
        </div>
