...
<template>
  <div class="flex items-center justify-center min-h-screen bg-[#12151C] p-6">
    ...
    <div class="w-full max-w-[380px]">
      ...
      <!-- Title & Sub -->
      <h1 class="text-center text-[#E8EAF0] text-[24px] font-serif font-medium mb-1">Content de te revoir</h1>
      ...
      <div class="space-y-4">
        ...
        <div class="text-center mt-5 text-[13px] text-[#8B93A7]">
          ...
          <RouterLink to="/register" class="text-[#FF7A33] font-semibold hover:underline transition-colors">
            Créer un compte
          </RouterLink>
        </div>
      </div>
